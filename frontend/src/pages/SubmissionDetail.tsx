...
const useSubmissionData = (submissionId: string | undefined) => {
  ...
  useEffect(() => {
    ...
    const savedCode = validateLanguageCode(
      sub.id,
      sub.language,
      localStorage.getItem(`code-${sub.id}`),
      sub.code
    );
...
export default function SubmissionDetail() {
  ...
  useEffect(() => {
    const checkMobile = () => {
      ...
      document.body.style.overflowY = newIsDesktop ? "hidden" : "auto";
    };
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <p className="text-foreground leading-relaxed mb-4">
                      Get detailed AI-powered analysis of your code solution,
                      including time complexity, space complexity, and
        ...
        <TabsContent value="code" className="space-y-4">
          <div
            className={`rounded-lg border p-3 ${
              isLightMode ? "bg-white border-gray-200" : "bg-card border-border"
            }`}
          >
            <div className="flex items-center justify-between mb-3">
              <h3
