    ...
    return (
      <div className={`relative ${className}`}>
        ...
        <div className="absolute top-3 right-3 flex gap-2">
          <button
            onClick={handleSave}
            className="px-3 py-1.5 text-xs bg-slate-700 dark:bg-slate-600 hover:bg-slate-800 dark:hover:bg-slate-700 text-white rounded-md transition-all duration-200 shadow-sm hover:shadow-md font-medium border-0 transform hover:scale-105 active:scale-95"
          ...
          <button
            ...
            className="px-3 py-1.5 text-xs bg-gray-500 hover:bg-gray-600 text-white rounded-md transition-all duration-200 shadow-sm hover:shadow-md font-medium border-0 transform hover:scale-105 active:scale-95"
